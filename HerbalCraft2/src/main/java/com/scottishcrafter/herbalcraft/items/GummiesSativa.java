...
public class GummiesSativa  extends Item implements IHasModel
{
	public GummiesSativa(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			SativaGummiesUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}