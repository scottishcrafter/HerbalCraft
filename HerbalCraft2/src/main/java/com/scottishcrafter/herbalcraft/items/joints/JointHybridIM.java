...
public class JointHybridIM extends ItemFood implements IHasModel {
	
	public JointHybridIM(String name, int amount, boolean isWolfFood)
	{
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
    {
        if (entityLiving instanceof EntityPlayer)
        {
            ...
            if (entityplayer instanceof EntityPlayerMP)
            {
                ...
                ItemHandlerHelper.giveItemToPlayer(((EntityPlayerMP) entityplayer), new ItemStack(ItemInit.ROACH_HYBRID_IM, (int) (1)));
            }
        }
