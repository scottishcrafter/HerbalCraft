...
public class BrownieHybridIM extends ItemFood implements IHasModel {
	
	public BrownieHybridIM(String name, int amount, boolean isWolfFood)
	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add("Indica, Medicinal Hybrid");
	}
