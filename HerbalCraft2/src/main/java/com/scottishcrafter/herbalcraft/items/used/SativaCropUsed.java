...
public class SativaCropUsed {

	public SativaCropUsed(Main instance) {
		super();
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (entity instanceof EntityPlayer)
			((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemInit.CROPDROP_SATIVA, (int) (1)).getItem(), -1, (int) 1, null);
	}
}
