...
public class VapeMedicinal extends ItemFood implements IHasModel {
	
	public VapeMedicinal(String name, int amount, boolean isWolfFood)
	{
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		if(!worldIn.isRemote) {
			...
			player.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 2400, 2, false, true));
		}
