...
public class CropDropHemp  extends Item implements IHasModel
{
	public CropDropHemp(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			HempCropUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}