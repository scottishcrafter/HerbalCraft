...
public class VapeSativa extends ItemFood implements IHasModel {
	
	public VapeSativa(String name, int amount, boolean isWolfFood)
	{
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		if(!worldIn.isRemote) {
			player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 2400, 2, false, true));
