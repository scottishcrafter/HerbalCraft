...
public class BrownieHybridSM extends ItemFood implements IHasModel {
	
	public BrownieHybridSM(String name, int amount, boolean isWolfFood)
	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add("Sativa, Medicinal Hybrid");
	}
