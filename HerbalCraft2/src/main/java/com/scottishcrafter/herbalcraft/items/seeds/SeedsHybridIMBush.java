...
public class SeedsHybridIMBush extends ItemFood implements IHasModel, IPlantable {
	
	public SeedsHybridIMBush(String name, int amount, boolean isWolfFood)
	{
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.BUSH_HYBRID_IM.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		...
		return BlockInit.BUSH_HYBRID_IM.getDefaultState();
	}
