...
public class SeedsHybridSI extends ItemFood implements IHasModel, IPlantable {
	
	public SeedsHybridSI(String name, int amount, boolean isWolfFood)
	{
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.HYBRID_PLANT_SI.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		...
		return BlockInit.HYBRID_PLANT_SI.getDefaultState();
	}
