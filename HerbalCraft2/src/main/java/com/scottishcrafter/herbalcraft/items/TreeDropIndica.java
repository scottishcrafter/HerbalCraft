...
public class TreeDropIndica  extends Item implements IHasModel
{
	public TreeDropIndica(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			IndicaTreeDropUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}