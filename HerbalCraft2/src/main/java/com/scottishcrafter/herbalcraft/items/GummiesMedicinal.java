...
public class GummiesMedicinal  extends Item implements IHasModel
{
	public GummiesMedicinal(String name, CreativeTabs tab) 
	{
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add("Right Click me to open!");
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			MedicinalGummiesUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}