...
public class VapeHybridIM extends ItemFood implements IHasModel {
	
	public VapeHybridIM(String name, int amount, boolean isWolfFood)
	{
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
		if(!worldIn.isRemote) {
			...
			player.addPotionEffect(new PotionEffect(MobEffects.MINING_FATIGUE, 2400, 2, false, true));
