...
public class GummiesIndica  extends Item implements IHasModel
{
	public GummiesIndica(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			IndicaGummiesUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}