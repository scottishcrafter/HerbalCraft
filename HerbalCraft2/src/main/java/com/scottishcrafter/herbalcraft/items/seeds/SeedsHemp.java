...
public class SeedsHemp extends ItemFood implements IHasModel, IPlantable {
	
	public SeedsHemp(String name, int amount, boolean isWolfFood)
	{
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.HEMP_PLANT.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		...
		return BlockInit.HEMP_PLANT.getDefaultState();
	}
