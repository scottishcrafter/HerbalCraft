...
public class IMCropUsed {

	public IMCropUsed(Main instance) {
		super();
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (entity instanceof EntityPlayer)
			ItemHandlerHelper.giveItemToPlayer(((EntityPlayer) entity), new ItemStack(ItemInit.BUD_HYBRID_IM, (int) (3)));
		if (entity instanceof EntityPlayer)
			((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemInit.CROPDROP_HYBRID_IM, (int) (1)).getItem(), -1, (int) 1, null);
