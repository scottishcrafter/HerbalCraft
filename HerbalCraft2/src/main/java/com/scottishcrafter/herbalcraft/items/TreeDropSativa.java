...
public class TreeDropSativa  extends Item implements IHasModel
{
	public TreeDropSativa(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			SativaTreeDropUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}