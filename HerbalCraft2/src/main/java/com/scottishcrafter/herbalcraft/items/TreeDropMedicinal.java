...
public class TreeDropMedicinal  extends Item implements IHasModel
{
	public TreeDropMedicinal(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			MedicinalTreeDropUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}