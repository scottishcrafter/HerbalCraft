...
public class CropDropSativa  extends Item implements IHasModel
{
	public CropDropSativa(String name, CreativeTabs tab) 
	{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
		ActionResult<ItemStack> ar = super.onItemRightClick(world, entity, hand);
		{
			...
			SativaCropUsed.executeProcedure($_dependencies);
		}
		return ar;
	}
}