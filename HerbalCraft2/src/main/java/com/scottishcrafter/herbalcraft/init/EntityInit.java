...
public class EntityInit 
{
	...
	{
		registerEntity("stoned_cow", EntityStonedCow.class, ModConfiguration.ENTITY_STONED_COW_ID, 2, 	2771239, 8289918);
		...
		registerEntity("stoned_chicken", EntityStonedChicken.class, ModConfiguration.ENTITY_STONED_CHICKEN_ID, 2, 	2771239, 8650752);
