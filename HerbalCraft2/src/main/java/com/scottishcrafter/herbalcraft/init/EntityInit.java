...
public class EntityInit 
{
	...
	public static void registerEntities()
	{
		...
		EntityRegistry.addSpawn(EntityStonedCow.class, 2, 1, 4, EnumCreatureType.AMBIENT,BiomeDictionary.getBiomes(Type.PLAINS).toArray(new Biome[0]));
		registerEntity("stoned_chicken", EntityStonedChicken.class, ModConfiguration.ENTITY_STONED_CHICKEN_ID, 50, 	2771239, 8650752);
		EntityRegistry.addSpawn(EntityStonedChicken.class, 2, 1, 4, EnumCreatureType.AMBIENT,BiomeDictionary.getBiomes(Type.PLAINS).toArray(new Biome[0]));
		registerEntity("stoned_pig", EntityStonedPig.class, ModConfiguration.ENTITY_STONED_PIG_ID, 50, 	2771239, 12605267);
		EntityRegistry.addSpawn(EntityStonedPig.class, 2, 1, 4, EnumCreatureType.AMBIENT,BiomeDictionary.getBiomes(Type.PLAINS).toArray(new Biome[0]));
	}
