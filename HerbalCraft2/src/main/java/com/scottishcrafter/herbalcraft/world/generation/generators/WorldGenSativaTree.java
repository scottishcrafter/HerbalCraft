...
public class WorldGenSativaTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.SATIVA_LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.SATIVA_LEAVES.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenSativaTree() 
	{
		super(false);
		this.minHeight = 12;
	}
