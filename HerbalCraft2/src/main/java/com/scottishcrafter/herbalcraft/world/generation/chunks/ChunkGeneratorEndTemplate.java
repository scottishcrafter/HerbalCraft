package com.scottishcrafter.herbalcraft.world.generation.chunks;
...
public class ChunkGeneratorEndTemplate implements IChunkGenerator
{
	...
	protected static final IBlockState MAIN_BLOCK = BlockInit.HEMPINGOT_BLOCK.getDefaultState();
    ...
    public ChunkGeneratorEndTemplate(World world, boolean mapFeaturesEnabled, long seed, BlockPos spawn)
    {
        ...
        spawnableCreatureList.add(new SpawnListEntry(EntityStonedCow.class, 10, 1, 5));
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.CANNALAND);
        }
