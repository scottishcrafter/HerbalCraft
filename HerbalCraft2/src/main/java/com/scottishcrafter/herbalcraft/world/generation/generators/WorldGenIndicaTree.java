...
public class WorldGenIndicaTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.INDICA_LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.INDICA_LEAVES.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenIndicaTree() 
	{
		super(false);
		this.minHeight = 12;
	}
