...
public class WorldGenMedicinalTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.MEDICINAL_LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.MEDICINAL_LEAVES.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenMedicinalTree() 
	{
		super(false);
		this.minHeight = 12;
	}
